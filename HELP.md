...
git clone https://github.com/PodishettiRakesh/RAG_System.git
cd RAG_System
...
**Persistent Storage**: Replace in-memory FAISS with:
- FAISS on disk
...
**Memory Errors**: Reduce chunk size or use smaller models
**Slow Responses**: Check FAISS index size and model loading
**Poor Search Results**: Verify embedding quality and chunk relevance
**LLM Hallucination**: Ensure context is relevant and well-formatted
